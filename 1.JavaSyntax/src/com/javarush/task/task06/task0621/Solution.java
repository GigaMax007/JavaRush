...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        String grandFatherOfFatherName = reader.readLine();
//        String grandMotherOfFatherName = null;
        Cat grandFatherFather = new Cat(grandFatherOfFatherName);
        Cat grandMotherFather = null;

//        String grandFatherOfMotherName = null;
        String grandMotherOfMotherName = reader.readLine();
        Cat grandMotherMother = new Cat(grandMotherOfMotherName);
        Cat grandFatherMother = null;

        String fatherName = reader.readLine();
        Cat catFather = new Cat(fatherName, grandMotherFather, grandFatherFather);

        String motherName = reader.readLine();
        Cat catMother = new Cat(motherName, grandMotherMother, grandFatherMother);

        String childSunName = reader.readLine();
        Cat catSun = new Cat(childSunName, catMother, catFather);

        String childDautherName = reader.readLine();
        Cat catDaughter = new Cat(childDautherName, catMother, catFather);
    ...
    public static class Cat {
        ...
        public String toString() {
            ...
            else return "The cat's name is " + name + ", mother is " + parentMother.name + ", father is " + parentFather.name;
        }
    }
